...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MicroCoinApi.ChangeKey();
  });
  ...
  describe('ChangeKey', function() {
    it('should create an instance of ChangeKey', function() {
      // uncomment below and update the code to test ChangeKey
      //var instane = new MicroCoinApi.ChangeKey();
      //expect(instance).to.be.a(MicroCoinApi.ChangeKey);
    });

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MicroCoinApi.ChangeKeyRequest();
  });
  ...
  describe('ChangeKeyRequest', function() {
    it('should create an instance of ChangeKeyRequest', function() {
      // uncomment below and update the code to test ChangeKeyRequest
      //var instane = new MicroCoinApi.ChangeKeyRequest();
      //expect(instance).to.be.a(MicroCoinApi.ChangeKeyRequest);
    });
    ...
    it('should have the property newOwnerPublicKey (base name: "newOwnerPublicKey")', function() {
      // uncomment below and update the code to test the property newOwnerPublicKey
      //var instane = new MicroCoinApi.ChangeKeyRequest();
      //expect(instance).to.be();
    });

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MicroCoinApi.SimpleKey();
  });
  ...
  describe('SimpleKey', function() {
    it('should create an instance of SimpleKey', function() {
      // uncomment below and update the code to test SimpleKey
      //var instane = new MicroCoinApi.SimpleKey();
      //expect(instance).to.be.a(MicroCoinApi.SimpleKey);
    });
